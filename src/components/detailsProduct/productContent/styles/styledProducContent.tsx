...
import { colorBackgroundButton, colorBorder, colorText, colorTextDestaque, font } from '../../../ui/variables';
...
export const ProductImageDescription = styled(ProductDescriptionImage)`
    height: 100%;
`;
...
export const ImageButtonSize = styled.input`
    border: 1px solid ${colorBorder};
    border-radius: 15%;
    height: 5vh;
    grid-column: 1;

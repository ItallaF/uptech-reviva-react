...
export default function ProductList(){
    ...
    return(
        <aside>
        <h4 className={style.produto__lista__titulo}>Ultimos Lançamentos</h4>
        <section className={style.produto__lista} >
            {listProduct.slice(0,4).map(({id, nameProduct, url, price, description, sizes_available, quantity_available, images}) =>

                        ...
                        <ProductListImageBorder>
                            ...
                            <ProductListImageButton >
                                {products.sizesAvailable.map((t, index) => (
                                    ...
                                    </ProductListImageButtonSize>
                                ))}
                            </ProductListImageButton>
                            <Link to={{ pathname: `/Details/${products.id}` }} />
                        </ProductListImageBorder>
                        <ProductListText >
                            <p>{products.nameProduct}
                            </p>
                        </ProductListText>
                        <ProductListPrice>
                            <p>{products.price.toFixed(2).replace('.', ',')}</p>
                        </ProductListPrice>
                        <ProductListButton >
                            <ProductListButtonBag
                                onClick={() => addProductCart(products)}  data-testid="onclick">Por na Sacola
                                <ProductListButtonSvg >

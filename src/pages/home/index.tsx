...
export default function Home(){
    return (
        ...
        <div className="cabecalho__logo">
            <h1 className="cabecalho__logo__titulo">Reviva Fashion</h1>
            <p className="cabecalho__logo__texto">by RCHLO</p>
        </div>
        <div className="cabecalho__vetor">
            <a className="cabecalho__vetor__botao">
